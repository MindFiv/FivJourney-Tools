...
class TestTravelPlanCreation:
    ...
    def test_create_travel_plan_success(
        ...
        client: TestClient,
        auth_headers: dict,
        sample_travel_plan_data: dict,
    ):
        """测试创建旅行计划成功"""
        response = client.post(
            "/api/v1/travel-plans/",
            headers=auth_headers,
            json=sample_travel_plan_data,
        )
    ...
    def test_create_travel_plan_unauthorized(
        self, client: TestClient, sample_travel_plan_data: dict
    ):
        """测试未认证创建旅行计划"""
        response = client.post(
            "/api/v1/travel-plans/", json=sample_travel_plan_data
        )

        assert response.status_code == status.HTTP_401_UNAUTHORIZED

    def test_create_travel_plan_missing_required_fields(
        ...
        response = client.post(
            "/api/v1/travel-plans/", headers=auth_headers, json=incomplete_data
        )
    ...
    def test_create_travel_plan_invalid_dates(
        ...
        sample_travel_plan_data["start_date"] = (
            date.today() + timedelta(days=10)
        ).isoformat()
        sample_travel_plan_data["end_date"] = (
            date.today() + timedelta(days=5)
        ).isoformat()  # 结束日期早于开始日期
...
class TestTravelPlanQuery:
    ...
    def test_get_travel_plan_by_id_success(
        self,
        client: TestClient,
        auth_headers: dict,
        test_travel_plan: TravelPlan,
        ...
        """测试通过ID获取旅行计划成功"""
        response = client.get(
            f"/api/v1/travel-plans/{test_travel_plan.id}", headers=auth_headers
        )
    ...
    def test_get_travel_plan_by_id_not_found(
        self, client: TestClient, auth_headers: dict
    ):
        """测试获取不存在的旅行计划"""
        import uuid
        ...
        response = client.get(
            f"/api/v1/travel-plans/{fake_uuid}", headers=auth_headers
        )

        assert response.status_code == status.HTTP_404_NOT_FOUND

    def test_get_travel_plan_unauthorized(
    ...
    def test_get_other_user_travel_plan(
        self, client: TestClient, auth_headers: dict, test_db: AsyncSession
    ):
        """测试获取其他用户的旅行计划（应该失败）"""
...
class TestTravelPlanUpdate:
    ...
    def test_update_travel_plan_success(
        self,
        client: TestClient,
        auth_headers: dict,
        test_travel_plan: TravelPlan,
        ...
        response = client.put(
            f"/api/v1/travel-plans/{test_travel_plan.id}",
            headers=auth_headers,
            json=update_data,
        )
    ...
    def test_update_travel_plan_partial(
        self,
        client: TestClient,
        auth_headers: dict,
        test_travel_plan: TravelPlan,
    ...
    def test_update_travel_plan_not_found(
        self, client: TestClient, auth_headers: dict
    ):
        """测试更新不存在的旅行计划"""
        ...
        fake_uuid = str(uuid.uuid4())
        response = client.put(
            f"/api/v1/travel-plans/{fake_uuid}",
            headers=auth_headers,
            json=update_data,
        )
    ...
    def test_update_travel_plan_unauthorized(
        ...
        response = client.put(
            f"/api/v1/travel-plans/{test_travel_plan.id}", json=update_data
        )
...
class TestTravelPlanDeletion:
    ...
    def test_delete_travel_plan_success(
        self,
        client: TestClient,
        auth_headers: dict,
        test_travel_plan: TravelPlan,
    ...
    def test_delete_travel_plan_not_found(
        self, client: TestClient, auth_headers: dict
    ):
        """测试删除不存在的旅行计划"""
        import uuid
    ...
    def test_delete_travel_plan_unauthorized(
        self, client: TestClient, test_travel_plan: TravelPlan
    ):
        """测试未认证删除旅行计划"""
...
class TestTravelPlanFiltering:
    ...
    def test_filter_by_status(
        ...
        """测试按状态过滤旅行计划"""
        response = client.get(
            "/api/v1/travel-plans/?status=planning", headers=auth_headers
        )
    ...
    def test_filter_by_destination(
        ...
        """测试按目的地过滤旅行计划"""
        response = client.get(
            f"/api/v1/travel-plans/?destination={test_travel_plan.destination}",
            headers=auth_headers,
        )
    ...
    def test_pagination(self, client: TestClient, auth_headers: dict):
        """测试分页"""
        response = client.get(
            "/api/v1/travel-plans/?page=1&size=10", headers=auth_headers
        )
...
class TestTravelPlanIntegration:
    ...
    def test_travel_plan_lifecycle(
        self,
        client: TestClient,
        auth_headers: dict,
        sample_travel_plan_data: dict,
        ...
        # 2. 获取旅行计划
        get_response = client.get(
            f"/api/v1/travel-plans/{plan_id}", headers=auth_headers
        )
        ...
        list_response = client.get(
            "/api/v1/travel-plans/", headers=auth_headers
        )
